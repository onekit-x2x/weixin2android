...
public class Rotate3dAnimation extends android.view.animation.Animation {
     ...
     * 创建3D旋转动画
     *
     * @param fromDegrees the start angle of the 3D rotation 三维旋转起始角
     * @param toDegrees   the end angle of the 3D rotation 三维旋转的结束角
     * @param centerX     the X center of the 3D rotation 3D旋转X 中心
     * @param centerY     the Y center of the 3D rotation 3D旋转y 中心
     * @param depthZ      the Z depth of the 3D rotation  三维旋转的z深度
     * @param rotateAxis  the rotate axis of the 3D rotation 三维旋转的旋转轴
     * @param reverse     true if the translation should be reversed, false otherwise 颠倒
     */
